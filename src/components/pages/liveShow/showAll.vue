<template>
	<div>
		<ShowList :showData="list" :showempty='showempty'  ></ShowList>

		<loadlist @onempty='showEmpty'   @ondataupdate="getdata" :apiurl="'/YearCard/getCommentList/pageSize/20/p/@p'"></loadlist>
